...
min05 = sprintf('./graphdata/5.csv')
min10 = sprintf('./graphdata/10.csv')
min20 = sprintf('./graphdata/20.csv')
...
set label 11 at screen 0.75,0.265 '{\Large 5min}' front
set label 12 at screen 0.75,0.215 '{\Large 10min}' front
set label 13 at screen 0.75,0.165 '{\Large 20min}' front
...
set xlabel '{\footnotesize Interval [s]}' offset 0,0.7
set format x '$%g$'
set xrange [0:1500]
set xtics 500
set mxtics 2
...
plot \
min05 using ($1)*60:($6)*1000:($7)*1000 with yerrorlines ls 101 pt 3 ps 1.5 lw 3 title '',\
min10 using ($1)*60:($6)*1000:($7)*1000 with yerrorlines ls 102 pt 3 ps 1.5 lw 3 title '',\
min20 using ($1)*60:($6)*1000:($7)*1000 with yerrorlines ls 103 pt 3 ps 1.5 lw 3 title ''
...
plot \
min05 using ($1)*60:($4):($5) with yerrorlines ls 101 pt 3 ps 1.5 lw 3 title '',\
min10 using ($1)*60:($4):($5) with yerrorlines ls 102 pt 3 ps 1.5 lw 3 title '',\
min20 using ($1)*60:($4):($5) with yerrorlines ls 103 pt 3 ps 1.5 lw 3 title ''
...
min05 using 2:4:3:5 with xyerrorbars ls 101 pt 2 ps 2 lw 3.5 title '',\
min10 using 2:4:3:5 with xyerrorbars ls 102 pt 2 ps 2 lw 3.5 title '',\
min20 using 2:4:3:5 with xyerrorbars ls 103 pt 2 ps 2 lw 3.5 title '',\
