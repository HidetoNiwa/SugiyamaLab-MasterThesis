...
plot \
shiratori using 1:2 with points ls 114 pt  3 ps 1.5 lw 4 title 'Shiratori et al.[17]',\
h(x) ls 114 lw 4 title '',\
iwamuro using 1:2 with points ls 115 pt  3 ps 1.5 lw 4 title 'Iwamuro(2020) [7]',\
