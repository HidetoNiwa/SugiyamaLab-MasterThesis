...
magnet = sprintf('./graphdata/magnet.csv')
pump = sprintf('./graphdata/pump.csv')
iwamuro = sprintf('./graphdata/iwamuro.csv')
...
set label 1 at screen 0.6,0.20 point ls 101 pt 3 ps 2.5 lw 4
set label 2 at screen 0.6,0.15 point ls 102 pt 3 ps 2.5 lw 4
set label 3 at screen 0.6,0.1 point ls 103 pt 3 ps 2.5 lw 4
set label 4 at screen 0.6,0.05 point ls 111 pt 6 ps 2.5 lw 4

set label 11 at screen 0.685,0.20 '{\Large Magnet}' front
set label 12 at screen 0.69,0.15 '{\Large Vacuum}' front
set label 13 at screen 0.75,0.10 '{\Large Iwamuro(2020)}' front
set label 14 at screen 0.745,0.05 '{\Large Different cases}' front

set object 20 rect from screen 0.55,0.00 to screen 0.92,0.24 fc rgb '#FFFFFFFF' lw 2 back
...
set label 31 at graph 0.01,0.96 '(a)' front

set xlabel '{\Large $U_\text{off}\displaystyle [$\SI{}{mm/s}$]$}' offset 0,0
set format x '$%g$'
set xrange [100:200]
set xtics 50
set mxtics 2
...
plot \
pump using ($6)*1000:4:($7)*1000:5 with xyerrorlines ls 102 pt 3 ps 1.5 lw 3 title '',\
magnet using ($6)*1000:4:($7)*1000:5 with xyerrorlines ls 101 pt 3 ps 1.5 lw 3 title '',\
iwamuro using ($6)*1000:4:($7)*1000:5 with xyerrorlines ls 103 pt 3 ps 1.5 lw 3 title ''
...
pump using 2:4:3:5 with xyerrorbars ls 102 pt 2 ps 2 lw 3.5 title '',\
magnet using 2:4:3:5 with xyerrorbars ls 101 pt 2 ps 2 lw 3.5 title '',\
iwamuro using 2:4:3:5 with xyerrorbars ls 103 pt 2 ps 2 lw 3.5 title '',\
