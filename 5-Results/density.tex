\section{球密度による影響}
\label{sec:density}
超音波照射された擬塑性流体中を落下する球における高速化に関して，球密度による影響を考えるため，落下球の密度を変化させて実験を行った．実験条件をTable\ref{table:exp-conditions}に示す．落下球の高速化に関して，式(\ref{eq:Udiff})に示すよう球径による影響を受けるが，今回の実験条件において密度変化による影響よりも十分に小さいものとして球径は同一であったとして考える．
