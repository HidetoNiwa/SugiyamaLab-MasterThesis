...
\\usepackage{siunitx}\n \
"
set terminal epslatex size 5.4, 2.1 standalone color solid 9
...
plot \
al_02 using 8:6:7 with yerrorlines ls 101 pt 2 ps 1.5 lw 3 title 'Aluminum',\
...
plot \
stainless_02 using 8:6:7 with yerrorlines ls 103 pt 2 ps 1.5 lw 3 title 'Stainless',\
...
plot \
brass_02 using 8:6:7 with yerrorlines ls 104 pt 2 ps 1.5 lw 3 title 'Brass',\
